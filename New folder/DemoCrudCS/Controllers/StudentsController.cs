...
namespace DemoCrudCS.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var demoContext = _context.Students.Include(s => s.IdNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Sid,Id,Sname")] Student student)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Courses, "Id", "Id", student.Id);
            return View(student);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Sid,Id,Sname")] Student student)
        {
            if (id != student.Sid)
            {
                return NotFound();
